...
to build the android app i recommends usage of android studio with the newer sdk disponible and usage of opensdk to be more easily to gradlew handle things
after build and install the app you should set the permission to mock location manually at developer options of you device
